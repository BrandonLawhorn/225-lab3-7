pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/lawhorb'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/BrandonLawhorn/225-lab3-7.git'                                    //<------your MiamiID
        KUBECONFIG = credentials('lawhorb-225')                                                         //<------your MiamiID
    }
        ...
        stage ("Run Security Checks") {
            steps {
                ...
                sh '''
                    ...
                    -e BURP_START_URL=http://10.48.10.123 \
